    ...
    <div class="py-8 px-6 max-w-md mx-auto bg-white bg-opacity-30 rounded-lg shadow-lg backdrop-blur-xl backdrop-filter">
      ...
      <form action="/auth/register" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <input type="file" id="profile" name="profile" class="bg-transparent border rounded-lg shadow border-gray-300 focus:border-blue-500 text-white caret-blue-500 ring-2 block w-full appearance-none leading-normal file:bg-transparent file:border-none file:text-white cursor-pointer file:cursor-pointer file:py-2 file:px-4 file:bg-blue-500 file:border-r transition duration-300 ease-in-out" accept="image/jpg,image/jpeg,image/png">
        </div>
        ...
        <p class="text-center mt-4 text-gray-700">Already have an account? <a href="/auth/login" class="text-blue-500 font-semibold hover:underline">Login</a></p>
      </form>
    </div>
  </div>
</main>